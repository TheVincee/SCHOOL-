                    ...
                    <div class="teacher-box">
                        ...
                        ?>
                                <div class="teacher-card">
                                    ...
                                    <div class="buttons">
                                        <button class="update-teacher-button" id="updateTeacherButton" onclick="openUpdateModal(<?= $row['teacher_id'] ?>)"><img src="https://cdn-icons-png.flaticon.com/128/1688/1688988.png" alt=""></button>

                                        <a href="deleteTeacher.php?teacherId=<?= $row['teacher_id']?>" onclick="return confirm('Are you sure you want to delete this teacher?');"><button class="delete-teacher-button"><img src="https://cdn-icons-png.flaticon.com/128/9789/9789276.png" alt=""></button></a>
                                    </div>
                                </div>
                        <?php
                            }
