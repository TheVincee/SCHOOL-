                        ...
                        if ($result->rowCount() > 0) {
                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <div class="semester-card">
                                    ...
                                    <div class="buttons">
                                        <button class="update-semester-button" id="updateSemesterButton" onclick="openUpdateSemesterModal(<?= $row['semester_id'] ?>)"><img src="https://cdn-icons-png.flaticon.com/128/9497/9497023.png" alt=""></button>

                                        <a href="deleteSemester.php?semesterId=<?= $row['semester_id'] ?>" onclick="return confirm('Are you sure you want to delete this semester?');"><button class="delete-semester-button"><img src="https://cdn-icons-png.flaticon.com/128/9789/9789276.png" alt=""></button></a>
                                    </div>
                                </div>
                                <?php
                            }
