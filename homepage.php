        ...
        <div class="daddycontainer">
            ...
            <div class="pagecontainer">
                <div class="textcontainer">
                    <div class="hellotxt">CRMC SCHOOL SYSTEM<br></div>
                    <p>Welcome aboard to the Cebu Roosevelt Memorial Colleges School Management System.</p>
                    <br><br><br><br>
                </div>
                <div class="signup-buttons">
                        <button class="clientsignup_btn" onclick="openStudentLoginModal()">Student login</button>
                        <button class="freelancersignup_btn" onclick="openTeacherLoginModal()">Teacher login</button>
                </div>
            </div>
            <div id="studentModal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="createModal">
                        ...
                        <div class="eyebutton"><img src="https://cdn-icons-png.flaticon.com/128/179/179531.png" alt="" class="icon" id="studenteyeicon"></div>
            ...
            <div id="teacherModal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="createModal">
                        ...
                        <div class="eyebutton"><img src="https://cdn-icons-png.flaticon.com/128/179/179531.png" alt="" class="icon" id="teachereyeicon"></div>
