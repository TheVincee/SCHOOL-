...
<head>
    ...
    <link rel="stylesheet" href="teacherhomepage.css">
...
<body>
                        ...
                        if ($stmt->rowCount() > 0) {
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <div class="student-card">
                                    ...
                                    <div class="buttons">
                                        <a href="viewSubject.php?subject_id=<?= $subjectId ?>"><button class="view-student-button"><img src="https://cdn-icons-png.flaticon.com/128/218/218326.png" alt=""></button></a>
                                    </div>
                                </div>
                                <?php
                            }
    ...
    <script src="teacherhomepage.js"></script>
</body>
</html>