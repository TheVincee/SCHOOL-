                ...
                <div class="department-box">
                    ...
                    ?>
                            <div class="department-card">
                                ...
                                <div class="buttons">
                                    <a href="viewdepartment.php?department_id=<?= $row['department_id']?>"><button class="view-department-button"><img src="https://cdn-icons-png.flaticon.com/128/7483/7483927.png" alt=""></button></a>
                                    
                                    <button class="update-department-button" id="updateDepartmentButton" onclick="openUpdateModal(<?= $row['department_id'] ?>)"><img src="https://cdn-icons-png.flaticon.com/128/9497/9497023.png" alt=""></button>

                                    <a href="deleteDepartment.php?departmentId=<?= $row['department_id']?>" onclick="return confirm('Are you sure you want to delete this department?');"><button class="delete-department-button"><img src="https://cdn-icons-png.flaticon.com/128/9789/9789276.png" alt=""></button></a>
